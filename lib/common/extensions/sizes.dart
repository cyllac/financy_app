...
class Sizes {
  ...
  static void init(BuildContext context, {Size designSize = _designSize}) {
    // verifica se existe dados da MediaQuery
...
extension SizeExt on num {
  ...
  double get w => (this * Sizes._instance._width) / Sizes._designSize.width;

  //calcula o valor proporcional baseado na altura do dispositivo em relação ao protótipo
  double get h => (this * Sizes._instance._height) / Sizes._designSize.height;
}
